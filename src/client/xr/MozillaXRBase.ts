...
export default class MozillaXRBase {
	...
	_startSession() {
		let sessionInitParameters: XRSessionCreateParametersInit = {
			exclusive: false,
			type: 'augmentation',
			videoFrames: false,
			alignEUS: false,
		...
		for (let display of this._xrDisplays) {
	...
	async createImageAnchor(uid: string, buffer: ArrayBuffer, width: number, height: number, 
